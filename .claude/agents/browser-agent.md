...
This agent handles all browser-based operations to preserve the orchestrator's context window. It manages Chrome automation for web scraping, form filling, screenshots, and platform interactions with HotelRunner and Booking.com. The agent ensures proper tab management, captures evidence of actions, and handles browser connection issues gracefully.
