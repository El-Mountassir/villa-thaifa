...
## Additional Capabilities (References)

_The following endpoints are available in the HotelRunner Developer Portal but not yet fully documented here._

### REST API - Inventory

- [Get Room List](https://am.hotelrunner.com/custom-apps/rest-api/inventory/get-room-list)
- [Update Room (DateRange)](https://am.hotelrunner.com/custom-apps/rest-api/inventory/update-room)
- [Update Room (Daily)](https://am.hotelrunner.com/custom-apps/rest-api/inventory/update-room-multi-rooms-dates)

### REST API - Reservations

- [Retrieve Reservations](https://am.hotelrunner.com/custom-apps/rest-api/reservations/retrieve-reservations)
- [Realtime Push](https://am.hotelrunner.com/custom-apps/rest-api/reservations/realtime-push)
- [Reservation State Update](https://am.hotelrunner.com/custom-apps/rest-api/reservations/reservation-state-update)
- [Confirm Reservation Delivery](https://am.hotelrunner.com/custom-apps/rest-api/reservations/confirm-reservation-delivery)

### POS Integrations

- [Fetch Departments](https://am.hotelrunner.com/custom-apps/pos-integrations/fetch-departments)
- [Fetch Extras](https://am.hotelrunner.com/custom-apps/pos-integrations/fetch-extras)
- [Fetch Revenue Accounts](https://am.hotelrunner.com/custom-apps/pos-integrations/fetch-revenue-accounts)
- [In house Guest List](https://am.hotelrunner.com/custom-apps/pos-integrations/in-house-guest-list)
- [Transaction Cancel](https://am.hotelrunner.com/custom-apps/pos-integrations/invoice-cancel)
- [Posting](https://am.hotelrunner.com/custom-apps/pos-integrations/posting)

### Other Services

- [Channel List](https://am.hotelrunner.com/services/channel-list)
- [Get Currencies](https://am.hotelrunner.com/services/get-currencies)
- [Get Room Amenities](https://am.hotelrunner.com/services/get-room-amenities)
